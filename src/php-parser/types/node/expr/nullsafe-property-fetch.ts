...
export interface NullsafePropertyFetch extends Omit<Expr, 'nodeType'> {
  nodeType: 'Expr_NullsafePropertyFetch';
...
export type FullyQualifiedExprNullsafePropertyFetch = NullsafePropertyFetch;