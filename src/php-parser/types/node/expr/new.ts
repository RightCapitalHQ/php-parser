...
import type { NodeTypeInheritingFromFullyQualifiedStmtClass } from "../../types";
...
export interface New_ extends Omit<CallLike, 'nodeType'> {
  nodeType: 'Expr_New';

  ["class"] : NodeTypeInheritingFromFullyQualifiedName | NodeTypeInheritingFromFullyQualifiedExpr | NodeTypeInheritingFromFullyQualifiedStmtClass;
...
export type FullyQualifiedExprNew = New_;