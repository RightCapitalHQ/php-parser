...
export interface Namespace_ extends Omit<Stmt, 'nodeType'> {
  nodeType: 'Stmt_Namespace';

  ["name"] : null | NodeTypeInheritingFromFullyQualifiedName;
...
export type FullyQualifiedStmtNamespace = Namespace_;